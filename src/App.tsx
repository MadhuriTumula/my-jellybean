  ...
  <header className="border-b border-zinc-200 bg-white sticky top-0 z-50">
    <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
      ...
      >
        ...
        <span className="font-bold text-xl tracking-tight text-zinc-900">SafeKit Shield</span>
      </div>
  ...
  <footer className="border-t border-zinc-200 bg-zinc-50 py-12 mt-auto">
    <div className="max-w-5xl mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-bold text-lg">SafeKit Shield</span>
          </div>
      ...
      <div className="mt-8 pt-8 border-t border-zinc-200 text-center">
        <p className="text-xs text-zinc-400">© 2026 SafeKit Shield. Stay safe out there.</p>
      </div>
    </div>
  </footer>
);
